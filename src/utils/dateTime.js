...
export const parseDateToVietNam = (date) => {
   const originalDate = date instanceof Date ? date : new Date(date);

   // Lấy thời gian tương ứng theo múi giờ Việt Nam dưới dạng chuỗi chuẩn
   const vietNamString = originalDate.toLocaleString('en-US', {
